...
from corepkg.dep import _repo_separator
...
class MetadataRegen(AsyncScheduler):
    ...
    def _iter_metadata_processes(self):
        ...
        corepkg.writemsg_stdout("Regenerating cache entries...\n")
        for cp in self._cp_iter:
            if self._terminated.is_set():
                break
            cp_set.add(cp)
            corepkg.writemsg_stdout(f"Processing {cp}\n")
