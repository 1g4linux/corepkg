...
class SpawnProcess(SubProcess):
    """
    Constructor keyword args are passed into corepkg.process.spawn().
    ...
    def _spawn(
        ...
        spawn_func = corepkg.process.spawn

        if self._selinux_type is not None:
            spawn_func = corepkg.selinux.spawn_wrapper(spawn_func, self._selinux_type)
