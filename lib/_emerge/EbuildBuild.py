...
import corepkg
from corepkg import _encodings, _unicode_encode, os
from corepkg.package.ebuild.digestcheck import digestcheck
from corepkg.package.ebuild.doebuild import _check_temp_dir
from corepkg.package.ebuild._spawn_nofetch import SpawnNofetchWithoutBuilddir
...
class EbuildBuild(CompositeTask):
    ...
    def _pre_clean_exit(self, pre_clean_phase):
        ...
        # for log handling
        corepkg.prepare_build_dirs(self.pkg.root, self.settings, 1)
    ...
    def _build_exit(self, build):
        ...
        for pkg_fmt in corepkg.const.SUPPORTED_BINPKG_FORMATS:
