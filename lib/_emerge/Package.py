...
from corepkg.const import EBUILD_PHASES
...
from corepkg.dep.soname.parse import parse_soname_deps
from corepkg.versions import _pkg_str, _unknown_repo
from corepkg.eapi import _get_eapi_attrs
from corepkg.exception import InvalidData, InvalidDependString
...
class Package(Task):
    ...
    def __init__(self, **kwargs):
        ...
        self.category, self.pf = corepkg.catsplit(self.cpv)
        self.cp = self.cpv.cp
    ...
    def _eval_masks(self):
        ...
        if corepkg._eapi_is_deprecated(eapi):
    ...
    def __lt__(self, other):
        ...
        result = corepkg.vercmp(self.version, other.version)
        if result < 0:
            return True
...
_all_metadata_keys = frozenset(set(corepkg.auxdbkeys).union(Package.metadata_keys))
