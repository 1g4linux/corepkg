...
class AsynchronousLock(AsynchronousTask):
    """
    This uses the corepkg.locks module to acquire a lock asynchronously,
    ...
    def _start(self):
        ...
        self._proc = SpawnProcess(
            args=[
                ...
                os.path.join(corepkg._bin_path, "lock-helper.py"),
                self.path,
            ],
            env=dict(os.environ, PORTAGE_PYM_PATH=corepkg._pym_path),
