...
class EbuildMetadataPhase(SubProcess):
    ...
    async def _async_start(self):
        ...
        from corepkg.package.ebuild.doebuild import doebuild
        ...
        with open(
            ...
            self._eapi, self._eapi_lineno = corepkg._parse_eapi_ebuild_head(f)
        ...
        self.eapi_supported = corepkg.eapi_is_valid_for_runtime(parsed_eapi)
    ...
    def _async_start_done(self, future):
        ...
        self.corepkg_ebuild_extra_source = self.settings.get(
    ...
    def _unregister(self):
        ...
        if self.corepkg_ebuild_extra_source:
            os.unlink(self.corepkg_ebuild_extra_source)
    ...
    def _async_waitpid_cb(self, *args, **kwargs):
        ...
        if self.returncode == os.EX_OK and self._raw_metadata is not None:
            ...
            if metadata_valid:
                ...
                if parsed_eapi is None:
                    parsed_eapi = "8"
                self.eapi_supported = corepkg.eapi_is_valid_for_runtime(
                    metadata["EAPI"]
                )
    ...
    def _eapi_invalid(self, metadata):
        from corepkg.package.ebuild._metadata_invalid import eapi_invalid
