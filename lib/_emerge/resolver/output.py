...
from corepkg.dep import Atom, cpvequal, _repo_separator, _slot_separator
from corepkg.exception import InvalidDependString, SignatureException
...
from corepkg.versions import best, cpv_getversion
