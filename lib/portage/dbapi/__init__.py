...
from corepkg.const import MERGING_IDENTIFIER

from corepkg import os
from corepkg import auxdbkeys
...
class dbapi:
    ...
    def match(self, origdep: str, use_cache: int = 1):
        ...
        """
        from corepkg.dbapi.dep_expand import dep_expand as _dep_expand
    ...
    def _iter_match(self, atom: str, cpv_iter):
        from corepkg.dep import match_from_list
    ...
    def _iter_match_slot(self, atom, cpv_iter):
        from corepkg.dep import _match_slot
