...
from corepkg.module import Modules
...
def emaint_main(myargv):
    ...
    module_controller = Modules(path=module_path, namepath="corepkg.emaint.modules")
    ...
    if args[0] == "all":
        ...
        corepkg.util.writemsg(module_opts(module_controller, args[0]), noiselevel=-1)
        sys.exit(1)
