...
corepkg._sync_mode = True
from corepkg.binrepo.config import BinRepoConfigLoader
from corepkg.const import PORTAGE_BASE_PATH, BINREPOS_CONF_FILE
from corepkg.output import bold, red, create_color_func
from corepkg._global_updates import _global_updates
from corepkg.sync.controller import SyncManager
from corepkg.util.digraph import digraph
from corepkg.util.futures import asyncio
from corepkg.util._async.AsyncScheduler import AsyncScheduler
...
class SyncRepos:
    ...
    def __init__(self, emerge_config=None, emerge_logging=False):
        ...
        if emerge_config is None:
            ...
            if hasattr(corepkg, "settings"):
                ...
                corepkg._reset_legacy_globals()
                # update redundant global variables, for consistency
                # and in order to conserve memory
                corepkg.settings = emerge_config.target_config.settings
                corepkg.db = emerge_config.trees
    ...
    def _check_updates(self):
        ...
        Corepkg always includes itself in this list to check.
        """
        ...
        early_update_packages = {
            corepkg.const.PORTAGE_PACKAGE_ATOM: "Corepkg",
        }
        ...
        for early_pkg, early_name in early_update_packages.items():
            ...
            installed_pv = corepkg.best(vartree.dbapi.match(early_pkg))
            ...
            # Suggest to update to the latest available version of corepkg.
