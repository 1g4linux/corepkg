...
class CleanLogs:
    ...
    def clean(self, **kwargs):
        ...
        @param **kwargs: optional dictionary of values used in this function are:
                settings: corepkg settings instance: defaults to corepkg.settings
        ...
        # convoluted, I know, but corepkg.settings does not exist in
        # kwargs.get() when called from _emerge.main.clean_logs()
        settings = kwargs.get("settings", getattr(corepkg, "settings", {}))
