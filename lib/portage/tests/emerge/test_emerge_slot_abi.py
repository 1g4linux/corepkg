...
class SlotAbiEmergeTestCase(TestCase):
    def testSlotAbiEmerge(self):
        ...
        ebuilds = {
            ...
            "dev-libs/glib-2.30.2": {"EAPI": "8", "SLOT": "2/2.30"},
            "dev-libs/glib-2.32.3": {"EAPI": "8", "SLOT": "2/2.32"},
        ...
        installed = {
            "dev-libs/glib-1.2.10": {"EAPI": "8", "SLOT": "1"},
            "dev-libs/glib-2.30.2": {"EAPI": "8", "SLOT": "2/2.30"},
            "dev-libs/dbus-glib-0.98": {
                "EAPI": "8",
        ...
        dirs = [distdir, fake_bin, corepkg_tmpdir, user_config_dir, var_cache_edb]
