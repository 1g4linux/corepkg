# test_NewsItem.py -- Corepkg Unit Testing Functionality
# Copyright 2007-2024 Gentoo Authors
# Distributed under the terms of the GNU General Public License v2

from corepkg.tests import TestCase
from corepkg.news import NewsItem, NewsManager
...
class NewsItemTestCase(TestCase):
    ...
    The revdep-rebuild tool is provided by app-corepkg/gentoolkit.
    """
        ),
    }
    ...
    def setUp(self) -> None:
        ...
        self.keywords = "x86"
        # Consumers only use ARCH, so avoid corepkg.settings by using a dict
    ...
    def testDisplayIfInstalled(self):
        self.vardb.cpv_inject("sys-apps/corepkg-2.0", {"SLOT": "0"})

        self._checkAndCreateNewsItem({"display_if_installed": ["sys-apps/corepkg"]})
    ...
    def testMultipleRestrictions(self):
        ...
        self._checkAndCreateNewsItem(
            {
                ...
                "display_if_installed": ["sys-apps/corepkg"],
            }
        )
        ...
        # they all match?
        # (Note that sys-apps/corepkg is already "installed" by this point
