...
from corepkg.const import EBUILD_SH_BINARY
from corepkg.package.ebuild.config import config
from corepkg.package.ebuild.doebuild import spawn as doebuild_spawn
...
class DoebuildSpawnTestCase(TestCase):
    """
    Invoke corepkg.package.ebuild.doebuild.spawn() with a
    ...
    def testDoebuildSpawn(self):
        ...
        try:
            ...
            for phase in ("_internal_test",):
                ...
                # returnpid=False. This case is no longer used by corepkg
