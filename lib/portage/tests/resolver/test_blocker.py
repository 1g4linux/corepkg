...
class SlotConflictWithBlockerTestCase(TestCase):
    def testBlocker(self):
        ebuilds = {
            ...
            "dev-libs/X-1": {"EAPI": "8", "RDEPEND": "!=dev-libs/Y-1"},
            "dev-libs/X-2": {"EAPI": "8", "RDEPEND": "!=dev-libs/Y-2"},
            "dev-libs/X-3": {"EAPI": "8", "RDEPEND": "!=dev-libs/Y-3"},
            "dev-libs/Y-1": {"SLOT": "1"},
            "dev-libs/Y-2": {"SLOT": "2"},
            "dev-libs/Y-3": {"SLOT": "3"},
        }
    ...
    def testBlockerBuildpkgonly(self):
        ebuilds = {
            "dev-libs/A-1": {"EAPI": "8", "DEPEND": "!!dev-libs/X"},
            "dev-libs/B-1": {"EAPI": "8", "BDEPEND": "!!dev-libs/X"},
            "dev-libs/C-1": {"EAPI": "8", "BDEPEND": "!dev-libs/X"},
            "dev-libs/D-1": {"EAPI": "8", "DEPEND": "!dev-libs/X"},
            "dev-libs/E-1": {"EAPI": "8", "RDEPEND": "!dev-libs/X !!dev-libs/X"},
            "dev-libs/F-1": {"EAPI": "8", "PDEPEND": "!dev-libs/X !!dev-libs/X"},
        }
