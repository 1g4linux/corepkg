...
class OrChoicesTestCase(TestCase):
    def testOrChoices(self):
        ebuilds = {
            "dev-lang/vala-0.20.0": {"EAPI": "8", "SLOT": "0.20"},
            "dev-lang/vala-0.18.0": {"EAPI": "8", "SLOT": "0.18"},
            # "dev-libs/gobject-introspection-1.36.0" : {
            # 	"EAPI": "8",
            # 	"RDEPEND" : "!<dev-lang/vala-0.20.0",
            # },
            "dev-libs/gobject-introspection-1.34.0": {"EAPI": "8"},
    ...
    def testInitiallyUnsatisfied(self):
        ebuilds = {
            "app-misc/A-1": {"EAPI": "8", "SLOT": "0/1"},
            "app-misc/A-2": {"EAPI": "8", "SLOT": "0/2"},
            "app-misc/B-0": {"EAPI": "8", "RDEPEND": "app-misc/A:="},
            "app-misc/C-0": {"EAPI": "8", "RDEPEND": "|| ( app-misc/X <app-misc/A-2 )"},
        }

        installed = {
            "app-misc/A-1": {"EAPI": "8", "SLOT": "0/1"},
            "app-misc/B-0": {"EAPI": "8", "RDEPEND": "app-misc/A:0/1="},
            "app-misc/C-0": {"EAPI": "8", "RDEPEND": "|| ( app-misc/X <app-misc/A-2 )"},
        }
    ...
    def testUseMask(self):
        ...
        ebuilds = {
            ...
            "sys-libs/zlib-1.2.8-r1": {"EAPI": "8", "IUSE": "abi_ppc_32 abi_x86_32"},
            "sys-libs/zlib-1.2.8": {"EAPI": "8", "IUSE": ""},
        }
    ...
    def test_python_slot(self):
        ebuilds = {
            "dev-lang/python-3.8": {"EAPI": "8", "SLOT": "3.8"},
            "dev-lang/python-3.7": {"EAPI": "8", "SLOT": "3.7"},
            "dev-lang/python-3.6": {"EAPI": "8", "SLOT": "3.6"},
            "app-misc/bar-1": {
                "EAPI": "8",
    ...
    def test_virtual_w3m_realistic(self):
        ...
        """
        ebuilds = {
            "app-misc/neofetch-6.1.0": {"EAPI": "8", "RDEPEND": "www-client/w3m"},
            "app-text/xmlto-0.0.28-r1": {
                "EAPI": "8",
                "RDEPEND": "|| ( virtual/w3m www-client/lynx www-client/elinks )",
            },
...
class OrChoicesLibpostprocTestCase(TestCase):
    def testOrChoicesLibpostproc(self):
        ...
        # will be required.
        ebuilds = {
            "media-video/ffmpeg-0.10": {"EAPI": "8", "SLOT": "0.10"},
            "media-video/ffmpeg-1.2.2": {"EAPI": "8", "SLOT": "0"},
            "media-libs/libpostproc-0.8.0.20121125": {"EAPI": "8"},
        ...
        test_cases = (
            ...
            ResolverPlaygroundTestCase(
                ...
                success=True,
                all_permutations=True,
                mergelist=["media-video/ffmpeg-1.2.2"],
            ),
        )
