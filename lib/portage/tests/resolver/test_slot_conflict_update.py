...
class SlotConflictUpdateTestCase(TestCase):
    def testSlotConflictUpdate(self):
        ebuilds = {
            "app-text/podofo-0.9.2": {"EAPI": "8", "RDEPEND": "dev-util/boost-build"},
            "dev-cpp/libcmis-0.3.1": {"EAPI": "8", "RDEPEND": "dev-libs/boost:="},
            ...
            "dev-util/boost-build-1.53.0": {"EAPI": "8", "SLOT": "0"},
            "dev-util/boost-build-1.52.0": {"EAPI": "8", "SLOT": "0"},
        }

        installed = {
            "app-text/podofo-0.9.2": {"EAPI": "8", "RDEPEND": "dev-util/boost-build"},
            "dev-cpp/libcmis-0.3.1": {"EAPI": "8", "RDEPEND": "dev-libs/boost:0/1.52="},
            "dev-util/boost-build-1.52.0": {"EAPI": "8", "SLOT": "0"},
            "dev-libs/boost-1.52.0": {
                "EAPI": "8",
                "SLOT": "0/1.52",
