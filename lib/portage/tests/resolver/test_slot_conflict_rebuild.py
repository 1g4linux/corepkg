...
class SlotConflictRebuildTestCase(TestCase):
    def testSlotConflictRebuild(self):
        ebuilds = {
            ...
            "app-misc/D-1": {"EAPI": "8", "SLOT": "0/1"},
            "app-misc/D-2": {"EAPI": "8", "SLOT": "0/2"},
            "app-misc/E-0": {
                "EAPI": "8",
                "DEPEND": "app-misc/D:=",
                "RDEPEND": "app-misc/D:=",
    ...
    def testSlotConflictMassRebuild(self):
        ...
        ebuilds = {
            ...
            "app-misc/B-1": {"EAPI": "8", "SLOT": "1"},
            "app-misc/B-2": {"EAPI": "8", "SLOT": "2/2"},
        }
    ...
    def testSlotConflictDepChange(self):
        ...
        ebuilds = {
            ...
            "app-misc/B-1": {"EAPI": "8", "SLOT": "0/1"},
            "app-misc/B-2": {"EAPI": "8", "SLOT": "0/2"},
        }
    ...
    def testSlotConflictMixedDependencies(self):
        ...
        """
        ebuilds = {
            "cat/slotted-lib-1": {"EAPI": "8", "SLOT": "1"},
            "cat/slotted-lib-2": {"EAPI": "8", "SLOT": "2"},
            "cat/slotted-lib-3": {"EAPI": "8", "SLOT": "3"},
            "cat/slotted-lib-4": {"EAPI": "8", "SLOT": "4"},
            "cat/slotted-lib-5": {"EAPI": "8", "SLOT": "5"},
            "cat/user-1": {
                "EAPI": "8",
    ...
    def testSlotConflictMultiRepo(self):
        ...
        """
        ebuilds = {
            "net-firewall/iptables-1.4.21::overlay": {"EAPI": "8", "SLOT": "0/10"},
            "sys-apps/iproute2-3.11.0::overlay": {
                "EAPI": "8",
                "RDEPEND": "net-firewall/iptables:=",
            },
            "net-firewall/iptables-1.4.21": {"EAPI": "8", "SLOT": "0"},
    ...
    def testSlotConflictMultiRepoUpdates(self):
        ...
        ebuilds = {
            "net-firewall/iptables-1.4.21::overlay": {"EAPI": "8", "SLOT": "0/10"},
            "net-firewall/iptables-1.4.21-r1::overlay": {"EAPI": "8", "SLOT": "0/10"},
            "sys-apps/iproute2-3.11.0::overlay": {
                "EAPI": "8",
                "RDEPEND": "net-firewall/iptables:=",
            },
            "net-firewall/iptables-1.4.21": {"EAPI": "8", "SLOT": "0"},
            "net-firewall/iptables-1.4.21-r1": {"EAPI": "8", "SLOT": "0"},
            "sys-apps/iproute2-3.12.0": {
                "EAPI": "8",
                "RDEPEND": "net-firewall/iptables:=",
            },
    ...
    def testSlotConflictRebuildGolang(self):
        ebuilds = {
            "dev-lang/go-1.14.7": {"EAPI": "8", "SLOT": "0/1.14.7"},
            "dev-lang/go-1.15": {"EAPI": "8", "SLOT": "0/1.15"},
