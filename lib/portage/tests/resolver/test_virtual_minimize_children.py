...
class VirtualMinimizeChildrenTestCase(TestCase):
    def testVirtualMinimizeChildren(self):
        ebuilds = {
            "app-misc/bar-1": {"EAPI": "8", "RDEPEND": "virtual/foo"},
            "virtual/foo-1": {
                "EAPI": "8",
    ...
    def testVirtualPackageManager(self):
        ebuilds = {
            "app-admin/perl-cleaner-2.25": {
                "RDEPEND": """
					|| (
						( sys-apps/corepkg app-corepkg/corepkg-utils )
						sys-apps/pkgcore
						sys-apps/paludis
					)"""
            },
            "app-corepkg/corepkg-utils-0.64": {},
            "sys-apps/paludis-2.6.0": {},
            "sys-apps/corepkg-2.3.19-r1": {},
        ...
        test_cases = (
            ...
            # packages than the ( corepkg corepkg-utils ) choice which
