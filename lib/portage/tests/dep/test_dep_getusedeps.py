# test_dep_getusedeps.py -- Corepkg Unit Testing Functionality
# Copyright 2007-2010 Gentoo Foundation
# Distributed under the terms of the GNU General Public License v2

from corepkg.tests import TestCase
from corepkg.dep import dep_getusedeps

from corepkg.tests import test_cps, test_slots, test_versions, test_usedeps
