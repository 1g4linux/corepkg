...
if TYPE_CHECKING:
    import corepkg.dbapi.vartree
    import corepkg.package.ebuild.config
...
from corepkg.const import NEWS_LIB_PATH
...
class NewsManager:
    ...
    def __init__(
        self,
        portdb: "corepkg.dbapi.porttree.portdbapi",
...
class NewsItem:
    ...
    It's purpose is to wrap parsing of these news items such that corepkg can determine
    ...
    def isRelevant(
        self,
        vardb: "corepkg.dbapi.vartree.vardbapi",
        config: "corepkg.package.ebuild.config.config",
