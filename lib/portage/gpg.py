...
from corepkg.exception import GPGException
from corepkg.output import colorize
from corepkg.util import varexpand, writemsg, writemsg_stdout
...
class GPG:
    ...
    def __init__(self, settings):
        """
        Corepkg settings are needed to run the GnuPG unlock command.
        """
