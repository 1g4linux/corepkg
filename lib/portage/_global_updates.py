...
from corepkg import best, os
from corepkg.const import WORLD_FILE
from corepkg.data import secpass
from corepkg.exception import DirectoryNotFound, PermissionDenied
from corepkg.localization import _
from corepkg.output import bold, colorize
from corepkg.update import (
    grab_updates,
    parse_updates,
    update_config_files,
    update_dbentry,
)
from corepkg.util import grabfile, writemsg, writemsg_stdout, write_atomic
                        ...
                        writemsg_stdout(
                            "  ".join(
                                (
                                    ...
                                    f"{bold('p')}='update /etc/corepkg/package.*'\n",
                                )
                            )
                        )
