...
from corepkg.dep import Atom, match_from_list
...
from corepkg.util import grablines
...
def getmaskingreason(
    ...
    if metadata is not None and not corepkg.eapi_is_valid_for_runtime(metadata["EAPI"]):
