...
"""
Methods to check whether Corepkg is going to write to read-only filesystems.
...
def get_ro_checker():
    """
    Uses the system type to find an appropriate method for testing whether Corepkg
