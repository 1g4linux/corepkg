...
from corepkg.exception import DirectoryNotFound, PermissionDenied, CorepkgException
...
# TODO: Remove dircache variable after stable corepkg does
...
def listdir(
    ...
    """
    Corepkg-specific implementation of os.listdir
