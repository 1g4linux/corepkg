...
from corepkg.util import apply_secpass_permissions, atomic_ofstream, writemsg
...
class MtimeDB(dict):
    ...
    # JSON read support has been available since corepkg-2.1.10.49.
    _json_write = True
    ...
    def __write_to_disk(self, d):
        ...
        try:
            ...
            apply_secpass_permissions(
                self.filename, uid=uid, gid=corepkg_gid, mode=0o644
            )
            self._clean_data = copy.deepcopy(d)
