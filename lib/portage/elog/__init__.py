...
from corepkg.exception import AlarmSignal, CorepkgException
from corepkg.process import atexit_register
from corepkg.elog.messages import collect_ebuild_messages, collect_messages
from corepkg.elog.filtering import filter_loglevels
...
def elog_process(cpv, mysettings, phasefilter=None):
    ...
    for key in all_logentries:
        ...
        for s, levels in logsystems.items():
            ...
            s = s.replace("-", "_")
            try:
                m = _load_mod("corepkg.elog.mod_" + s)
