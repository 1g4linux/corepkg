...
class TestAtom(TestCase):
    def testAtom(self):
        tests = (
            (
                "=sys-apps/corepkg-2.1-r1:0[doc,a=,!b=,c?,!d?,-e]",
                (
                    "=",
                    "sys-apps/corepkg",
                    "2.1-r1",
            ...
            (
                "=sys-apps/corepkg-2.1-r1*:0[doc]",
                ("=*", "sys-apps/corepkg", "2.1-r1", "0", "[doc]", None),
                False,
                False,
            ),
            (
                "sys-apps/corepkg:0[doc]",
                (None, "sys-apps/corepkg", None, "0", "[doc]", None),
                False,
                False,
            ),
            (
            ...
            ("*/corepkg", (None, "*/corepkg", None, None, None, None), True, False),
            (
                "s*s-*/corepkg:1",
                (None, "s*s-*/corepkg", None, "1", None, None),
                True,
                False,
            ),
            ...
            (
                "=sys-apps/corepkg-2.1-r1:0::repo_name[doc,a=,!b=,c?,!d?,-e]",
                (
                    "=",
                    "sys-apps/corepkg",
                    "2.1-r1",
            ...
            (
                "=sys-apps/corepkg-2.1-r1*:0::repo_name[doc]",
                ("=*", "sys-apps/corepkg", "2.1-r1", "0", "[doc]", "repo_name"),
                False,
                True,
            ),
            (
                "sys-apps/corepkg:0::repo_name[doc]",
                (None, "sys-apps/corepkg", None, "0", "[doc]", "repo_name"),
                False,
                True,
            ),
            (
            ...
            (
                "*/corepkg::repo_name",
                (None, "*/corepkg", None, None, None, "repo_name"),
                True,
                True,
            ),
            (
                "s*s-*/corepkg:1::repo_name",
                (None, "s*s-*/corepkg", None, "1", None, "repo_name"),
                True,
                True,
            ),
        )
        ...
        tests_xfail = (
            (Atom("sys-apps/corepkg"), False, False),
            ("cat/pkg\n", False, False),
            ("cat/Ҙ", False, False),
            ...
            ("cat/pkg[?a!]", False, False),
            ("cat/pkg[?a-]", False, False),
            ("sys-apps/corepkg[doc]:0", False, False),
            ("*/*", False, False),
            ("sys-apps/*", False, False),
            ("*/corepkg", False, False),
            ("*/**", True, False),
            ("*/corepkg[use]", True, False),
            ("cat/pkg[a()]", False, False),
            ("cat/pkg[a(]", False, False),
            ("cat/pkg[a)]", False, False),
            ...
            ("cat/pkg[-a(+),a(-)]", False, False),
            ("cat/pkg[-a(-),a(+)]", False, False),
            ("sys-apps/corepkg[doc]::repo_name", False, False),
            ("sys-apps/corepkg:0[doc]::repo_name", False, False),
            ("sys-apps/corepkg[doc]:0::repo_name", False, False),
            (
                "=sys-apps/corepkg-2.1-r1:0::repo_name[doc,a=,!b=,c?,!d?,-e]",
                False,
                False,
            ),
            ("=sys-apps/corepkg-2.1-r1*:0::repo_name[doc]", False, False),
            ("sys-apps/corepkg:0::repo_name[doc]", False, False),
