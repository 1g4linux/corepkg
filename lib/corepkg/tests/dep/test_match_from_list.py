...
from corepkg.dep import Atom, match_from_list, _repo_separator
from corepkg.versions import catpkgsplit, _pkg_str
...
class Test_match_from_list(TestCase):
    def testMatch_from_list(self):
        tests = (
            ...
            ("=sys-apps/corepkg-045", ["sys-apps/corepkg-046"], []),
            (
                "~sys-apps/corepkg-045",
                ["sys-apps/corepkg-045-r1"],
                ["sys-apps/corepkg-045-r1"],
            ),
            ("~sys-apps/corepkg-045", ["sys-apps/corepkg-046-r1"], []),
            (
                "<=sys-apps/corepkg-045",
                ["sys-apps/corepkg-045"],
                ["sys-apps/corepkg-045"],
            ...
            ("<=sys-apps/corepkg-045", ["sys-apps/corepkg-046"], []),
            (
                "<sys-apps/corepkg-046",
                ["sys-apps/corepkg-045"],
                ["sys-apps/corepkg-045"],
            ),
            ("<sys-apps/corepkg-046", ["sys-apps/corepkg-046"], []),
            (
                ">=sys-apps/corepkg-045",
                ["sys-apps/corepkg-045"],
                ["sys-apps/corepkg-045"],
            ),
            (">=sys-apps/corepkg-047", ["sys-apps/corepkg-046-r1"], []),
            (
                ">sys-apps/corepkg-044",
                ["sys-apps/corepkg-045"],
                ["sys-apps/corepkg-045"],
            ),
            (">sys-apps/corepkg-047", ["sys-apps/corepkg-046-r1"], []),
            (
                "sys-apps/corepkg:0",
                [Package("=sys-apps/corepkg-045:0")],
                ["sys-apps/corepkg-045"],
            ),
            ("sys-apps/corepkg:0", [Package("=sys-apps/corepkg-045:1")], []),
            ...
            (
                "=sys-apps/corepkg-2*",
                ["sys-apps/corepkg-2.1"],
                ["sys-apps/corepkg-2.1"],
            ),
            (
                "=sys-apps/corepkg-2.1*",
                ["sys-apps/corepkg-2.1.2"],
                ["sys-apps/corepkg-2.1.2"],
            ),
            ("dev-libs/*", ["sys-apps/corepkg-2.1.2"], []),
            ("*/tar", ["sys-apps/corepkg-2.1.2"], []),
