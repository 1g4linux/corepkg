...
class MergelistOutputTestCase(TestCase):
    def testMergelistOutput(self):
        ...
        ebuilds = {
            ...
            "dev-libs/B-1": {"DEPEND": "dev-libs/D", "IUSE": "foo +bar", "EAPI": "8"},
            "dev-libs/C-1": {"DEPEND": "dev-libs/E", "IUSE": "foo bar"},
            "dev-libs/D-1": {"IUSE": ""},
            "dev-libs/E-1": {},
            # reinstall for flags
            "dev-libs/Z-1": {"IUSE": "+foo", "EAPI": "8"},
            "dev-libs/Y-1": {"IUSE": "foo", "EAPI": "8"},
            "dev-libs/X-1": {},
            "dev-libs/W-1": {"IUSE": "+foo", "EAPI": "8"},
        }

        installed = {
            "dev-libs/Z-1": {"USE": "", "IUSE": "foo"},
            "dev-libs/Y-1": {"USE": "foo", "IUSE": "+foo", "EAPI": "8"},
            "dev-libs/X-1": {"USE": "foo", "IUSE": "+foo", "EAPI": "8"},
            "dev-libs/W-1": {},
        }
