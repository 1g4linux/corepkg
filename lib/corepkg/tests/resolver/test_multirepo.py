...
class MultirepoTestCase(TestCase):
    def testMultirepo(self):
        ebuilds = {
            ...
            "dev-libs/G-1::repo1": {"EAPI": "8", "IUSE": "+x +y", "REQUIRED_USE": ""},
            "dev-libs/G-1::repo2": {
                "EAPI": "8",
                "IUSE": "+x +y",
                "REQUIRED_USE": "^^ ( x y )",
    ...
    def testMultirepoUserConfig(self):
        ebuilds = {
            ...
            "dev-libs/A-3::repo2": {},
            "dev-libs/B-1": {"DEPEND": "dev-libs/A", "EAPI": "8"},
            "dev-libs/B-2": {"DEPEND": "dev-libs/A[foo]", "EAPI": "8"},
            "dev-libs/B-3": {"DEPEND": "dev-libs/A[-foo]", "EAPI": "8"},
