...
class AutounmaskTestCase(TestCase):
    def testAutounmask(self):
        ebuilds = {
            ...
            "dev-libs/A-1": {"SLOT": 1, "DEPEND": "dev-libs/B[foo]", "EAPI": "8"},
            "dev-libs/A-2": {"SLOT": 2, "DEPEND": "dev-libs/B[bar]", "EAPI": "8"},
            "dev-libs/B-1": {
            ...
            "dev-libs/E-1": {"SLOT": 1, "DEPEND": "dev-libs/F[masked-flag]", "EAPI": "8"},
            "dev-libs/E-2": {
                "SLOT": 2,
            ...
            "sci-libs/K-7": {"DEPEND": " || ( sci-libs/M sci-libs/L[bar] )", "EAPI": "8"},
            "sci-libs/K-8": {"DEPEND": " || ( sci-libs/L[bar] sci-libs/M )", "EAPI": "8"},
            ...
            "app-corepkg/A-1": {"DEPEND": "app-corepkg/B[foo]", "EAPI": "8"},
            "app-corepkg/A-2": {
                "DEPEND": "app-corepkg/B[foo=]",
                "IUSE": "+foo",
                "REQUIRED_USE": "foo",
                "EAPI": "8",
            },
        ...
        test_cases = (
            ...
            # (see "package.use" in the corepkg(5) man page for more details)
            ...
            # The following USE changes are necessary to proceed:
            #  (see "package.use" in the corepkg(5) man page for more details)
            # # required by app-corepkg/A-1::test_repo
            # # required by =app-corepkg/A-1 (argument)
            # >=app-corepkg/B-1 foo
            #
            # !!! The ebuild selected to satisfy "app-corepkg/B[foo]" has unmet requirements.
            # - app-corepkg/B-1::test_repo USE="bar (forced-flag) -foo"
            #
            ...
            ResolverPlaygroundTestCase(
                ["=app-corepkg/A-1"],
                options={"--autounmask": True},
                use_changes={"app-corepkg/B-1": {"foo": True}},
                success=False,
            ),
            # The following USE changes are necessary to proceed:
            #  (see "package.use" in the corepkg(5) man page for more details)
            # # required by app-corepkg/A-2::test_repo
            # # required by =app-corepkg/A-2 (argument)
            # >=app-corepkg/B-1 foo
            #
            # !!! The ebuild selected to satisfy "app-corepkg/B[foo=]" has unmet requirements.
            # - app-corepkg/B-1::test_repo USE="bar (forced-flag) -foo"
    ...
    def testAutounmaskForLicenses(self):
        ebuilds = {
            ...
            "dev-libs/C-1": {"DEPEND": "dev-libs/B[foo]", "EAPI": "8"},
