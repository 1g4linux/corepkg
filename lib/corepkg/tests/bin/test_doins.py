# test_doins.py -- Corepkg Unit Testing Functionality
...
from corepkg.tests.bin import setup_env
from corepkg import tests
    ...
    def testDoInsOptionGroupName(self):
        ...
        try:
            ...
            try:
                ...
                self.skipTest(f"missing group database entry for gid {gid}")
