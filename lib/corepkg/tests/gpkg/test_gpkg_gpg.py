...
from corepkg.exception import MissingSignature, InvalidSignature
        ...
        playground = ResolverPlayground(
            user_config={
                "make.conf": (
                    ...
                    'BINPKG_FORMAT="gpkg"',
                    f'BINPKG_GPG_SIGNING_BASE_COMMAND="flock {gpg_test_path}/corepkg-binpkg-gpg.lock /usr/bin/gpg --sign --armor --batch --no-tty --yes --pinentry-mode loopback --passphrase GentooTest [PORTAGE_CONFIG]"',
