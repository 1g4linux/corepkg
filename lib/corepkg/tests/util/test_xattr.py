...
"""Tests for the corepkg.util._xattr module"""
...
from corepkg.util._xattr import xattr as _xattr, _XattrSystemCommands, _XattrStub
...
def MockSubprocessPopen(stdin):
    ...
    proc.stdin.write(corepkg._unicode_encode(stdin, corepkg._encodings["stdio"]))
    return proc
