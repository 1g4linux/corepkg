...
from corepkg.checksum import perform_md5
from corepkg.util.file_copy import copyfile, _fastcopy
...
class CopyFileSparseTestCase(TestCase):
    def testCopyFileSparse(self):
        ...
        try:
            ...
            with patch("corepkg.util.file_copy._fastcopy", new=mock_fastcopy):
                copyfile(src_path, dest_path)
