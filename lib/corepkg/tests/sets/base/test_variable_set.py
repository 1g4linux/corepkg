...
class VariableSetTestCase(TestCase):
    def testVariableSetEmerge(self):
        rust_with_rustc_rebuild = "{class=corepkg.sets.dbapi.VariableSet,variable=BDEPEND,includes=dev-lang/rust dev-lang/rust-bin}"

        ebuilds = {
            "dev-lang/go-1": {},
            "dev-go/go-pkg-1": {"EAPI": "8", "BDEPEND": "dev-lang/go"},
