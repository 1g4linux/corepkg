...
from corepkg.const import BASH_BINARY, PORTAGE_PYM_PATH
...
from corepkg.util import ensure_dirs, find_updated_config_files
...
"""
        ...
        dirs = [distdir, fake_bin, corepkg_tmpdir, var_cache_edb]
