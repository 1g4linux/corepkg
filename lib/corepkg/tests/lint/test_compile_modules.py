...
from corepkg.const import PORTAGE_BIN_PATH, PORTAGE_PYM_PATH, PORTAGE_PYM_PACKAGES
from corepkg.tests import TestCase
from corepkg.tests.lint.metadata import module_metadata, script_metadata
from corepkg import os
from corepkg import _encodings
from corepkg import _unicode_decode, _unicode_encode
