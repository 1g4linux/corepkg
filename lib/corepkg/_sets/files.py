...
from corepkg.util import grabfile, write_atomic, ensure_dirs, normalize_path
from corepkg.const import USER_CONFIG_PATH, VCS_DIRS, WORLD_FILE, WORLD_SETS_FILE
from corepkg.localization import _
from corepkg.locks import lockfile, unlockfile
from corepkg import corepkg_gid
from corepkg._sets.base import PackageSet, EditablePackageSet
from corepkg._sets import SetConfigError, SETPREFIX, get_boolean
from corepkg.env.loaders import ItemFileLoader, KeyListFileLoader
from corepkg.env.validators import ValidAtomValidator
from corepkg import cpv_getkey
...
class WorldSelectedPackagesSet(EditablePackageSet):
    ...
    def _ensure_dirs(self):
        ensure_dirs(
            os.path.dirname(self._filename), gid=corepkg_gid, mode=0o2750, mask=0o2
        )
