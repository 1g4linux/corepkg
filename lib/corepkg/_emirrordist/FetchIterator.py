...
from corepkg.exception import CorepkgException, CorepkgKeyError
from corepkg.package.ebuild.fetch import DistfileName
...
def _async_fetch_tasks(config, hash_filter, repo_config, digests_future, cpv, loop):
    ...
    @type config: corepkg._emirrordist.Config.Config
    @param hash_filter: PORTAGE_CHECKSUM_FILTER settings
    @type hash_filter: corepkg.checksum._hash_filter
    ...
    def aux_get_done(gather_result):
        ...
        except (CorepkgKeyError, CorepkgException) as e:
        ...
        except (OSError, CorepkgException) as e:
