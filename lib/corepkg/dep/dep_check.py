...
import corepkg
from corepkg.dep import Atom, match_from_list, use_reduce
from corepkg.dep._dnf import (
    dnf_convert as _dnf_convert,
    contains_disjunction as _contains_disjunction,
)
from corepkg.exception import InvalidDependString, ParseError
    ...
    for cp in overlap_graph:
        ...
        if len(disjunctions) > 1:
            ...
            for x in sorted(disjunctions.values(), key=order_key):
                dep_repr = corepkg.dep.paren_enclose(x, opconvert=True)
