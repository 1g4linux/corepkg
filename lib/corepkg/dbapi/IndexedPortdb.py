...
from corepkg.cache.index.IndexStreamIterator import IndexStreamIterator
from corepkg.cache.index.pkg_desc_index import (
...
class IndexedPortdb:
    ...
    def match(self, atom):
        ...
        if atom == atom.cp:
            return cp_list[:]
        return corepkg.match_from_list(atom, cp_list)
