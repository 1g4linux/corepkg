...
import corepkg
from corepkg.cache import fs_template
from corepkg.cache import cache_errors
...
class database(fs_template.FsBased):
    ...
    def _db_cursor(self):
        if (
            ...
            or self._db_connection_info.pid != corepkg.getpid()
        ):
    ...
    def _db_init_connection(self):
        ...
        try:
            ...
            self._db_connection_info = self._connection_info_entry(
                connection, cursor, corepkg.getpid()
            )
