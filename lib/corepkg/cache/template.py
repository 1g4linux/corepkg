...
from corepkg.cache.cache_errors import InvalidRestriction
...
class database:
    ...
    def __contains__(self, cpv):
        ...
        if self.has_key is database.has_key:
            ...
            raise NotImplementedError
        warnings.warn(
            "corepkg.cache.template.database.has_key() is "
...
def serialize_eclasses(eclass_dict, chf_type="mtime", paths=True):
    ...
    """The "new format", which causes older versions of <corepkg-2.1.2 to
