...
import os as _os
from corepkg.cache import template
...
class FsBased(template.database):
    ...
    def _ensure_access(self, path, mtime=-1):
        ...
        from corepkg.util import apply_permissions
