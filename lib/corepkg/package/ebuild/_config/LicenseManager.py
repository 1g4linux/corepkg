...
from corepkg.dep import ExtendedAtomDict, use_reduce
from corepkg.exception import InvalidDependString
from corepkg.localization import _
from corepkg.util import grabdict, grabdict_package, writemsg
from corepkg.versions import cpv_getkey, _pkg_str
