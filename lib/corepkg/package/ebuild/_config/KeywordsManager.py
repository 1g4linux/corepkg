...
from corepkg.package.ebuild._config.helper import ordered_by_atom_specificity
from corepkg.repository.config import allow_profile_repo_deps
from corepkg.util import grabdict_package, stack_lists
...
class KeywordsManager:
    ...
    def __init__(
        ...
        if user_config:
            ...
            if pkgdict and corepkg._internal_caller:
                warnings.warn(
