...
from corepkg import _unicode_encode, _encodings
from corepkg.const import MANIFEST2_IDENTIFIERS
...
from corepkg.util import atomic_ofstream, grablines, varexpand, writemsg
