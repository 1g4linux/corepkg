...
from corepkg.const import MANIFEST2_HASH_DEFAULTS
from corepkg.dbapi.porttree import FetchlistDict
...
from corepkg.package.ebuild.fetch import fetch
from corepkg.util import writemsg, writemsg_stdout
...
def digestgen(myarchives=None, mysettings=None, myportdb=None):
    ...
    if mysettings is None or myportdb is None:
        raise TypeError(
            "corepkg.digestgen(): 'mysettings' and 'myportdb' parameter are required."
        )
