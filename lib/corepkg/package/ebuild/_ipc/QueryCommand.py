...
from corepkg.dep import Atom, _repo_name_re
from corepkg.eapi import eapi_has_repo_deps
from corepkg.elog import messages as elog_messages
from corepkg.exception import InvalidAtom
from corepkg.package.ebuild._ipc.IpcCommand import IpcCommand
from corepkg.util import normalize_path, no_color
...
class QueryCommand(IpcCommand):
    ...
    def _elog(self, elog_funcname, lines):
        ...
        try:
            corepkg.output.havecolor = not no_color(self.settings)
            for line in lines:
