...
doc = """Zipfile plug-in module for corepkg.
Performs a http download of a corepkg snapshot and unpacks it to the repo
location."""
__doc__ = doc[:]
...
from corepkg.sync.config_checks import CheckSyncConfig
