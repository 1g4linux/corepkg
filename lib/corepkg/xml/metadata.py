...
from corepkg.util import cmp_sort_key, unique_everseen
...
class _Maintainer:
    ...
    @ivar restrict: e.g. &gt;=corepkg-2.2 means only maintains versions
            of Corepkg greater than 2.2. Should be DEPEND string with < and >
...
class _Useflag:
    ...
    @ivar name: USE flag
    @type restrict: str or None
    @ivar restrict: e.g. &gt;=corepkg-2.2 means flag is only available in
