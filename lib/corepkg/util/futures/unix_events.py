...
from corepkg.util._eventloop.global_event_loop import (
...
class _CorepkgEventLoopPolicy:
    """
    Implementation of asyncio.AbstractEventLoopPolicy based on corepkg's
...
class _AsyncioEventLoopPolicy(_CorepkgEventLoopPolicy):
    """
    A subclass of _CorepkgEventLoopPolicy which raises
