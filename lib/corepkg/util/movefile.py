...
from corepkg.const import MOVE_BINARY
from corepkg.eapi import eapi_rewrites_symlinks
from corepkg.exception import OperationNotSupported
...
def movefile(
    ...
    lchown = _unicode_func_wrapper(corepkg.data.lchown, encoding=encoding)
    ...
    if hardlink_candidates:
        ...
        with tempfile.NamedTemporaryFile(
            dir=head, prefix=f".{tail}._corepkg_merge_.{corepkg.getpid()}"
