...
from corepkg import abssymlink
...
class PreservedLibsRegistry:
    ...
    # JSON read support has been available since corepkg-2.2.0_alpha89.
    _json_write = True
