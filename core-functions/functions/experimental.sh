...
# not considered as being sufficiently within the scope of core-functions as
...
warn "sourcing the experimental module from core-functions; no stability guarantee is provided"
