...
# Runtime policy is single-EAPI (8), so only bash-5.0 compatibility is relevant.
___eapi_bash_3_2()                          { return 1; }
___eapi_bash_4_2()                          { return 1; }
___eapi_bash_5_0()                          { return 0; }
___eapi_bash_5_3()                          { return 1; }
